...
# TODO consider using Ansible 2.3 - module_utils feature: https://stackoverflow.com/questions/35328177/how-to-import-a-py-file-into-an-ansible-module
...
module: hdfscopy
version_added: "2.3"
short_description: Copies files to and from HDFS.
description:
...
def run(module, hdfs_client):
    ...
    # TODO UPDATE BELOW HERE for HDFS
    ...
    follow = module.params['follow']                 # TODO don't support follow!!!!!!
...
def main():
    ...
    module = AnsibleModule(
        ...
        argument_spec = dict(
            ...
            mode              = dict(required=False, default=None, type='raw'),  # TODO USED?
            owner             = dict(required=False, default=None, type='str'),  # TODO USED?
            directory_mode    = dict(required=False, type='raw'),
            remote_src        = dict(required=False, type='bool'),
        ),
        # add_file_common_args=True,  # TODO don't, but may need extra args from hdfsfile
