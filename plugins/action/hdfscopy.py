...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        for source_full, source_rel in source_files:
            ...
            # TODO remote_stat on HDFS, also:
            # TODO dest_status['exists']
            # TODO dest_status['isdir']
            # TODO dest_status['checksum']
            ...
            if local_checksum != dest_status['checksum']:
                ...
                if self._play_context.diff and not raw:
                    ...
                    # TODO this uses diff_peek in hdfsfile
                    # TODO would need to re-implement for HDFS
                ...
                # TODO update the above transfer file method, transfer to remote local FS, then do HDFS put in module?
                ...
                module_return = self._execute_module(module_name='hdfscopy',
                ...
                module_return = self._execute_module(module_name='hdfsfile',
                                                     module_args=new_module_args, task_vars=task_vars,
                                                     tmp=tmp, delete_remote_tmp=delete_remote_tmp)
                module_executed = True

            # TODO does hdfsfile/hdfscopy modeule return checksums? did file module?
